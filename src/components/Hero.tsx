...
export function Hero() {
	return (
		<section className="w-full py-16 md:py-24 flex flex-col items-center justify-center text-center px-4 bg-white">
			...
			<a
				href="#jobs"
				className="inline-flex items-center px-6 py-3 bg-slate-900 text-white font-semibold rounded-full shadow-sm hover:bg-slate-800 transition-colors mb-16"
			>
				Discover Open Roles
			</a>
		</section>
